...
object CoFlatMapFunctionExample {
  def main(args: Array[String]): Unit = {
    ...
    val stream1: KeyedStream[(Int, String), Int] = env.fromElements((1, "aaaaa"), (2, "bbbbb")).keyBy(r => r._1)


    val stream2: KeyedStream[(Int, String), Int] = env.fromElements((1, "cccccc"), (2, "dddddd")).keyBy(r => r._1)
  ...
  class MyFlatMapFunction extends CoFlatMapFunction[(Int, String), (Int, String),String]{
    ...
    override def flatMap1(value: (Int, String), out: Collector[String]): Unit = {
      ...
      out.collect(value._2+"来自第一条流发送两次")
      out.collect(value._2+"来自第一条流发送两次")
